...
void
ves_icall_System_Globalization_CompareInfo_construct_compareinfo (MonoCompareInfo *comp, MonoString *locale);
...
void
ves_icall_System_Globalization_CompareInfo_free_internal_collator (MonoCompareInfo *this_obj);
...
MonoString*
ves_icall_System_String_InternalReplace_Str_Comp (MonoString *this_obj, MonoString *old, MonoString *new_str, MonoCompareInfo *comp);

MonoString*
ves_icall_System_String_InternalToLower_Comp (MonoString *this_obj, MonoCultureInfo *cult);

MonoString*
ves_icall_System_String_InternalToUpper_Comp (MonoString *this_obj, MonoCultureInfo *cult);

gunichar2
ves_icall_System_Char_InternalToUpper_Comp (gunichar2 c, MonoCultureInfo *cult);

gunichar2
ves_icall_System_Char_InternalToLower_Comp (gunichar2 c, MonoCultureInfo *cult);
