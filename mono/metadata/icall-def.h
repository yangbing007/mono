...
HANDLES(COMPILERRTINFO_1, "ComputeStaticFieldAddress", ves_icall_Mono_Compiler_RuntimeInformation_ComputeStaticFieldAddress, gpointer, 1, (MonoClassField_ptr))
HANDLES(COMPILERRTINFO_2, "GetSRFieldInfoForToken", ves_icall_Mono_Compiler_RuntimeInformation_GetSRFieldInfoForToken, MonoReflectionField, 2, (MonoMethod_ptr, gint32))
